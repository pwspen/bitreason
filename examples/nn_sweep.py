...
from minireason.solvers import NeuralNetSolver
...
def main() -> None:
    ...
    solver = NeuralNetSolver(epochs=100, test_every=10, lr=0.01)
    ...
    plot_param_curves(
        ...
        output_path=log_dir / "example_advanced.png",
        title="Performance vs Train Samples (NeuralNetSolver)",
        per_task=True,
    )
